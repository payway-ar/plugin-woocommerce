...
//delete
    ...
    <div class="wrap">
        ...
        <?php if ($_POST['delete']) { ?>
            <div class="updated"><p>Promotion deleted</p></div>
            <a href="<?php echo admin_url('admin.php?page=prisma_promo_list') ?>">&laquo; Back to Promotions list</a>

        <?php } else if ($_POST['update']) { ?>
            <div class="updated"><p>Promotion updated</p></div>
            <a href="<?php echo admin_url('admin.php?page=prisma_promo_list') ?>">&laquo; Back to Promotions list</a>
