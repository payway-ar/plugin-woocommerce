...
//delete
    ...
    <div class="wrap">
        ...
        <?php if ($_POST['delete']) { ?>
            <div class="updated"><p>Bank deleted</p></div>
            <a href="<?php echo admin_url('admin.php?page=prisma_bank_list') ?>">&laquo; Back to Banks list</a>

        <?php } else if ($_POST['update']) { ?>
            <div class="updated"><p>Bank updated</p></div>
            <a href="<?php echo admin_url('admin.php?page=prisma_bank_list') ?>">&laquo; Back to Banks list</a>
