...
class WC_Decidir_Request {
    ...
    const CS_DECISION_SUCCESS_VALUES = [
        WC_Decidir_Cybersource_Validator_Interface::DECISION_GREEN,
        WC_Decidir_Cybersource_Validator_Interface::DECISION_YELLOW
    ];
	 ...
	 * with the Decidir Transaction ID
	 *
	 * @var int
	 */
	...
	public function __construct() {
		$this->api = new WC_Decidir_Api_Handler();
	}

	public function pay( $payment_data ) {
		try {
			/** @var WC_Decidir_Logger */
			$logger = wc_decidir_get_logger();
